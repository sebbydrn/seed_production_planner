...
@section('pageHeader')
	<h2>Data Monitoring For Seed Production Mobile App</h2>
	...
	<div class="right-wrapper pull-right">
		<ol class="breadcrumbs">
			...
			<li><span>Data Monitoring For Seed Production Mobile App</span></li>
		</ol>
					...
					<div class="card card-body" id="dailyData" style="background-color: #000; color: #fff; min-height: 405px; font-family: 'Courier New', Courier, monospace; font-size: 12px; padding: 10px;">
						...
						@if (count($dailyData) > 0)
							...
							@foreach ($dailyData as $item)
								@if ($count <= 5)
									<p class="mt-0 mb-0"><span style="color: #28a745;">[ {{$item['timestamp']}} ]</span> Data: [ Production Plot Code:"{{$item['productionPlotCode']}}"; Form:"{{$item['form']}}" ]</p>
								@endif
								@php
									$count++;
								@endphp
...
@push('scripts')
	@include('data_monitoring_geotag.scripts')
@endpush