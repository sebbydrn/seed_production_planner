...
<head>
	<meta charset="UTF-8">
	<title>Projected Seed Production Cost</title>
...
<body>
	<header>
		<table class="logo" style="width: 100%; padding-bottom: 20px;">
			<tr>
				<td>
		...
		<table class="header" style="width: 100%;">
			<tr>
				<td colspan="2" style="font-size: 16; text-align: center; font-weight: bold;">
	...
	<table class="content" style="width: 100%; margin-top: 40px;">
		<tr>
	...
	<table class="content" style="width: 100%; margin-top: 40px; page-break-before: always;">
		<tr>
		...
		<tr>
			...
			<th style="text-align: right;"><strong>{{number_format(array_sum($seed_cleaning_component), 2)}}</strong></th>
		</tr>

		<tr>
			<th colspan="2">G. Service Contractors</th>
			<th style="text-align: center;">Monthly Rate (P)</th>
			<th style="text-align: center;">Monthly Cost (P)</th>
			<th style="text-align: center;">Amount (P)</th>
		</tr>
		...
		@foreach($planting_materials as $item)
			...
			<tr>
				<th colspan="4" style="text-align: right;"><strong>Sub Total Sem {{$item->sem}}</strong></th>
				<th style="text-align: right;"><strong>{{number_format($item->sub_total, 2)}}</strong></th>
			</tr>
		...
		<tr>
			<th colspan="4" style="text-align: right;"><strong>TOTAL</strong></th>
			<th style="text-align: right;"><strong>{{number_format(array_sum($planting_material_component), 2)}}</strong></th>
		</tr>
	</table>
	...
	<table class="content" style="width: 100%; margin-top: 40px; page-break-before: always;">
		...
		<tr>
			...
			<th style="text-align: center;">Cost per ha (P)</th>
			<th style="text-align: center;">Amount (P)</th>
		</tr>
	...
	<table class="content" style="width: 100%; margin-top: 40px; margin-bottom: 40px; page-break-before: always;">
		<tr>
