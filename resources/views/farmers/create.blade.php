...
@section('pageHeader')
	...
	<div class="right-wrapper pull-right">
		<ol class="breadcrumbs">
			...
			<li><span>Add New Farmer</span></li>
		</ol>
		...
		<div class="col-md-4">
			<section class="panel">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Add New Farmer</h2>
				</header>
				...
				<div class="panel-body">
                    ...
                    <div class="form-group {{($errors->has('sex')) ? 'has-error' : ''}}">
                        ...
                        <input type="radio" name="sex" value="1" checked> Female <br>
                    ...
                    <div class="form-group {{($errors->has('rsbsa_no')) ? 'has-error' : ''}}">
                        ...
                        <input type="text" name="rsbsa_no" id="rsbsa_no" class="form-control" value="{{old('rsbsa_no')}}">
