		...
		<div class="col-md-4">
			<section class="panel">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Edit Activity</h2>
				</header>
				{!!Form::open(['method' => 'PATCH', 'route' => ['activities.update', $activity->activity_id]])!!}

				<input type="hidden" name="oldName" value="{{$activity->name}}">
