...
@section('pageHeader')
	...
	<div class="right-wrapper pull-right">
		<ol class="breadcrumbs">
			...
			<li><span>Fill-up Pest Management Form</span></li>
		</ol>
...
@section('pageContent')
	<a href="{{route('pest_management.index')}}" class="btn btn-primary mb-lg"><i class="fa fa-arrow-left"></i> Back</a>
		...
		<div class="col-md-4">
			<section class="panel">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Fill-up Pest Management Form</h2>
				</header>
				{!!Form::open(['route' => 'pest_management.store'])!!}
				...
				<div class="panel-body">
					...
					<!-- start: pest type input -->
					<div class="form-group">
						<label class="control-label">Pest Type</label>
						<select name="pest" id="pest" class="form-control mb-md">
					...
					<!-- start: specify pest -->
					<div class="form-group">
						<label class="control-label">Specify Pest</label>
						<input type="text" name="pestSpec" id="pestSpec" class="form-control">
					</div>
					<!-- end: specify pest -->
