...
@section('pageHeader')
	...
	<div class="right-wrapper pull-right">
		<ol class="breadcrumbs">
			...
			<li><span>Fill-up Land Preparation Form</span></li>
		</ol>
...
@section('pageContent')
	<a href="{{route('land_preparation.index')}}" class="btn btn-primary mb-lg"><i class="fa fa-arrow-left"></i> Back</a>
		...
		<div class="col-md-4">
			<section class="panel">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Fill-up Land Preparation Form</h2>
				</header>
				{!!Form::open(['route' => 'land_preparation.store'])!!}
				...
				<div class="panel-body">
					...
					<!-- start: cropping phase input -->
					<div class="form-group">
						<label class="control-label">Cropping Phase</label>
						<select name="cropPhase" id="cropPhase" class="form-control mb-md" onchange="setActivities()">
							<option selected disabled>Select Cropping Phase</option>
							<option value="For Seedbed">For Seedbed</option>
							<option value="For Transplanting">For Transplanting</option>
						</select>
					</div>
					<!-- end: cropping phase input -->
...
@push('scripts')
	...
	@include('seed_trace_geotag.land_preparation.js.options')
@endpush