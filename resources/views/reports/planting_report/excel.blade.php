<table>
	<tbody>
		...
		<tr>
			<td colspan="12" style="font-size: 20; text-align: center; font-weight: bold;">
				PLANTING REPORT
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="3" style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B;">Seed Source</td>
			...
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B; width: 25;">Date of Sowing</td>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B; width: 25;">Date of Transplanting</td>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B; width: 25;">Expected Date of Harvest</td>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B; width: 30;">Remarks</td>
		</tr>
		<tr>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B;"></td>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B;"></td>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B; width: 15;">Source</td>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B; width: 15;">Lot No.</td>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B; width: 15;">Lab No.</td>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B;"></td>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B;"></td>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B;"></td>
			<td style="border: 1px solid #000; text-align: center; font-weight: bold; background-color: #C4D69B;"></td>
